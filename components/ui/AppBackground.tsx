...
export default function AppBackground() {
  return (
    <>
      ...
      />
      <div className="fixed inset-0 pointer-events-none bg-grid-future opacity-35" />
      <div
        className="fixed top-0 right-0 w-[min(90vw,700px)] h-[500px] rounded-full blur-[120px] pointer-events-none animate-pulse-glow"
        style={{
          background:
