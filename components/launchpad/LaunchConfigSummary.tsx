  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
      <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
        <p className="text-[10px] font-bold text-slate-500 uppercase">Fixed supply</p>
      ...
      <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
        <p className="text-[10px] font-bold text-slate-500 uppercase">Start price</p>
        <p className="text-lg font-black text-white mt-1">{econ.priceUsdLabel}</p>
        <p className="text-[10px] text-slate-500 mt-1">{econ.priceEthLabel} · {config.quoteToken}</p>
      </div>
      <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/[0.06] p-4">
        <p className="text-[10px] font-bold text-slate-500 uppercase">Launch market cap</p>
        <p className="text-lg font-black text-emerald-300 mt-1">{econ.marketCapUsdLabel}</p>
        <p className="text-[10px] text-slate-500 mt-1">{econ.marketCapEthLabel}</p>
      </div>
    </div>
  );
}
