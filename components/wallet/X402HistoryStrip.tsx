        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <span className="text-[9px] font-semibold text-slate-400 bg-white/[0.04] border border-white/10 px-2 py-0.5 rounded-full">
                HTTP 402 · Base
              </span>
              {unlocked && (
                <span className="text-[9px] font-semibold text-slate-300 bg-white/[0.04] border border-white/10 px-2 py-0.5 rounded-full">
                  Unlocked
                </span>
              )}
            </div>
            ...
            {txUrl && (
              <a
                ...
                className="text-[10px] text-slate-400 hover:text-white underline mt-1 inline-block"
              >
