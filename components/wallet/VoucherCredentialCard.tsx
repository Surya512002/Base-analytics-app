...
export default function VoucherCredentialCard({
  ...
  return (
    <div className="rounded-2xl border-2 border-emerald-500/35 bg-emerald-500/6 p-4 sm:p-5 space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-2 pt-1">
        ...
        <button
          ...
          className="flex-1 flex items-center justify-center gap-2 py-3.5 rounded-xl font-black text-sm btn-primary active:scale-[0.98] transition"
        >
