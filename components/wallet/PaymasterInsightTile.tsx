...
export default function PaymasterInsightTile({ wallet }: { wallet: WalletData }) {
  ...
  return (
    <div className="elegant-panel rounded-2xl border border-cyan-500/20 p-4 flex items-start gap-3">
      <div className="w-11 h-11 rounded-xl bg-cyan-500/12 border border-cyan-500/25 flex items-center justify-center shrink-0">
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <span className="text-[8px] font-black uppercase tracking-widest text-cyan-400 bg-cyan-500/10 px-2 py-0.5 rounded-full border border-cyan-500/20">
            Base App · Paymaster
          </span>
        </div>
