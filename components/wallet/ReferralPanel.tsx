...
export default function ReferralPanel({ address }: ReferralPanelProps) {
  ...
  return (
    <div className="elegant-panel rounded-3xl overflow-hidden border border-[var(--border-subtle)]">
      <div className="p-5 sm:p-6">
        ...
        <div className="mt-4 flex flex-col sm:flex-row gap-2">
          <code className="flex-1 text-[11px] font-mono text-[var(--ink-muted)] bg-black/30 border border-white/10 rounded-xl px-3 py-2.5 truncate">
            {link}
          </code>
          <button
            type="button"
        ...
        <div className="grid grid-cols-2 gap-3 mt-4">
          <div className="rounded-xl bg-white/[0.04] border border-white/8 p-3 text-center">
            <Users size={16} className="text-[var(--ink-muted)] mx-auto mb-1" />
